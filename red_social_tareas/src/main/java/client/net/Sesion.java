...
public final class Sesion {
    ...
    public static final String HOST = "192.168.1.132"; // cambiar ip del servidor a la que se tiene que conectar 
    ...
    //por si el cliente no ha guardado la conexion se usa este metodo
    ...
    //metodos para recoger datos de conexion del usuario
